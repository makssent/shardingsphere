...
/**
 * Firebird put segment command packet.
 */
@Getter
public final class FirebirdPutSegmentCommandPacket extends FirebirdCommandPacket {

    private final int blobHandle;

    private final byte[] segment;

    public FirebirdPutSegmentCommandPacket(final FirebirdPacketPayload payload) {
