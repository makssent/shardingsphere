...
/**
 * Firebird open blob command executor.
 */
...
public final class FirebirdOpenBlobCommandExecutor implements CommandExecutor {
    ...
    public Collection<DatabasePacket> execute() throws SQLException {
        return Collections.singleton(new FirebirdGenericResponsePacket().setErrorStatusVector(new SQLException("Blob read is not supported yet.")));
    }
}
